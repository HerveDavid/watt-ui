...
let WattModal = class WattModal extends LitElement {
    constructor() {
        super(...arguments);
        this.open = false;
        this.size = 'm';
        ...
        if (changedProps.has('open')) {
            if (this.open) {
                ...
                requestAnimationFrame(() => {
                    const autoFocusTarget = this.modalElement.querySelector('[autofocus]');
                    if (autoFocusTarget) {
...
], WattModal.prototype, "open", void 0);
__decorate([
    property({ type: String, reflect: true })
], WattModal.prototype, "size", void 0);
__decorate([
    property({ type: String })
], WattModal.prototype, "returnValue", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], WattModal.prototype, "scrollable", void 0);
__decorate([
    query('.modal')
], WattModal.prototype, "modalElement", void 0);
__decorate([
    query('.modal-backdrop')
], WattModal.prototype, "backdropElement", void 0);
WattModal = __decorate([
